...
let leftMostColumnWithOne1 = function (binaryMatrix) {
  let rows = binaryMatrix.dimensions().get(0), cols = binaryMatrix.dimensions().get(1), smallestIndex = cols;
...
let leftMostColumnWithOne2 = function (binaryMatrix) {
  let rows = binaryMatrix.dimensions()[0], cols = binaryMatrix.dimensions()[1], smallestIndex = cols;
  ...
  for (let row = 0; row < rows; row++) {
    ...
    if (binaryMatrix.get(row, hi) == 1) smallestIndex = Math.min(smallestIndex, hi);
  }
...
var leftMostColumnWithOne3 = function (binaryMatrix) {
  let rows = binaryMatrix.dimensions()[0], cols = binaryMatrix.dimensions()[1], leftMost = -1;
  let r = 0, c = cols - 1;
