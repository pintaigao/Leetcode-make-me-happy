...
import { submitPost as submitPostThunk } from '../store/feedThunks';
...
export default function PostComposer() {
  ...
  const submit = useCallback(() => {
    ...
    setSubmitting(true);
    setError(null);
    Promise.resolve(dispatch(submitPostThunk(input)))
      .then(() => {
        setMessage('');
        setImageUrl('');
  ...
  }, [canSubmit, submitting, message, imageUrl, dispatch]);
